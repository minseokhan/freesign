...
export const FAQ_ITEMS: readonly FaqItem[] = [
  {
    question: "매듭으로 한 서명도 법적 효력이 있나요?",
    answer:
      "전자서명법은 당사자가 약정한 전자서명에 서명의 효력을 인정합니다. 매듭은 그 근거가 되는 증거를 남깁니다. 발송 시점의 원문 해시 동결, 상대방의 명시적 동의 캡처, 서명 시각·IP 기록, RFC 3161 타임스탬프, 완결증명서 PDF가 그것입니다. 다만 이는 법률 자문이 아니며, 분쟁 가능성이 큰 계약은 전문가 검토를 권장합니다.",
  },
  {
    question: "상대방(발주처)도 가입해야 하나요?",
    answer:
      "아니요. 상대방은 메일로 받은 링크에서 로그인 없이 서명합니다. 서명이 끝나면 계약서 PDF와 완결증명서 PDF가 양측 메일함으로 발송되므로, 상대방은 매듭에 접속하지 않고도 사본을 보관할 수 있습니다.",
  },
  {
