...
export function DashboardPreview() {
  return (
    ...
    >
      {/* 좁은 화면에서는 금액(3xl tabular-nums)이 2열에 들어가지 않아 가로 스크롤이 생긴다 */}
      <div className="grid grid-cols-1 gap-lg sm:grid-cols-2">
        <Card>
          ...
          <p className="mt-sm text-xs text-text-muted">미입금 인보이스 2건</p>
        </Card>
        <Card>
          <p className="text-xs font-medium uppercase tracking-wide text-text-muted">
            이달 수익
          ...
          <p className="mt-sm text-xs text-text-muted">입금 완료 2건</p>
        </Card>
      </div>
      ...
      <Card className="p-0">
        ...
        <table className="w-full border-collapse text-left text-sm">
          ...
          <tbody className="divide-y divide-surface-border">
            <tr>
              <td className="px-xl py-lg text-text-body">노드컴퍼니</td>
            ...
            <tr>
              <td className="px-xl py-lg text-text-body">무디</td>
              <td className="px-xl py-lg text-right font-medium tabular-nums text-text-primary">
                ₩2,400,000
              </td>
              <td className="px-xl py-lg">
